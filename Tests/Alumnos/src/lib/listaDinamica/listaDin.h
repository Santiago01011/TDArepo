 ...
 * @param *p Puntero a la lista.
 * @param cmp Función de comparación para determinar el orden de los elementos.
 * @return Puntero al puntero del nodo con el menor valor.
 */
tNodo** buscarMenorLista(tLista *p, int (*cmp)(const void*, const void*));

/**
 * @brief Ordena la lista utilizando el método de selección.
 * @param *p Puntero a la lista.
 * @param cmp Función de comparación para ordenar los elementos.
 * @return 1 en caso de éxito, 0 en caso de error.
 */
